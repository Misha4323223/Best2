...
function needsWebSearch(query) {
    ...
    const patterns = [
        ...
        /время работы|часы работы|расписание|работает ли|открыт|закрыт|график|режим работы/,
        
        // Финансы и экономика
        /курс|цена|стоимость|котировки|акции|доллар|евро|рубль|биткоин|крипто|инфляция|рынок/,
        
        // Поиск мест и навигация
        /где найти|где купить|адрес|как добраться|местоположение|координаты|рядом|поблизости/,
        
        // Статус сервисов и технологии
        /статус|доступен|работает сайт|не работает|отключение|сбой|обновление/,
        
        // Образование и справочная информация
        /что такое|определение|как работает|объясни|расскажи о|информация о/,
        
        // Здоровье и медицина
        /симптомы|лечение|врач|больница|аптека|лекарство|здоровье/,
        
        // Транспорт и путешествия
        /расписание поездов|билеты|рейсы|пробки|маршрут|транспорт/
    ];
